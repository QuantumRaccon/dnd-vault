...
**_Passive Properties_**. The following properties of the helm come into play even when no creature is attuned to it:
...
**_Active Properties_**. The sensation of being attuned to the helm is akin to being immersed in warm water. While attuned to the helm, you gain the following abilities while you sit in it:
...
**_Drawback_**. While attuned to the helm, you cannot expend your own spell slots.

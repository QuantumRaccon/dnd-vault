...
**_Damage Resistance_**. While the tattoo is on your skin, you have resistance to radiant damage.

**_Damage Absorption_**. When you take radiant damage, you can use your reaction to gain immunity against that instance of the damage, and you regain a number of hit points equal to half the damage you would have taken. Once this reaction is used, it can't be used again until the next dawn.

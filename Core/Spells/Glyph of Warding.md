...
school: "Abjuration"
casting_time: 1 hour
classes: ['Cleric', 'Artificer', 'Wizard', 'Bard']
concentration: False
ritual: False
areaTags: [sphere]
tags: spell
...
**_At Higher Levels_**. When you cast this spell using a spell slot of 4th level or higher, the damage of an explosive runes glyph increases by **1d8** for each slot level above 3rd. If you create a spell glyph, you can store any spell of up to the same level as the slot you use for the glyph of warding.
